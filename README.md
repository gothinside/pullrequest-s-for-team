...
Я решил не устанавлить уровень изоляции Serialize, потому что посчитал что серивсом будет пользоваться мало людей ( в оснвном сотрудники которых скажем не больше 200 человек) и вероятность аномалий связанных с этими уровнями(Фантомное и неповторяющееся чтение) исключены и не являются критичными для сервиса.
